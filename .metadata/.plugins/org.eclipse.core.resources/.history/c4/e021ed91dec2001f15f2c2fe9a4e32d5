...
public class StoreController {
	...
	// Add New Store
	@PostMapping("/add")
	public ResponseEntity<Store> addStore(@Validated @RequestBody StoreCreateDTO storecreateDTO)
	...
	public ResponseEntity<String> updateStorePhoneNumber(@PathVariable("storeId") Long storeId,
