...
public class FilmrentalstoreApplication {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.csrf().disable() // Disable CSRF protection
				...
				.permitAll().requestMatchers(HttpMethod.POST, "/api/actors/post").permitAll()
				.requestMatchers(HttpMethod.GET, "/api/actors/lastname/{ln}").permitAll()
				.requestMatchers(HttpMethod.GET, "/api/actors/firstname/{fn}").permitAll()
				.requestMatchers(HttpMethod.PUT, "/api/actors/update/*").permitAll()
				.requestMatchers(HttpMethod.PUT, "/api/actors/{id}/films").permitAll()
				.requestMatchers(HttpMethod.GET, "/api/actors/{id}/film").permitAll()
				.requestMatchers(HttpMethod.PUT, "/api/actors/toptenbyfilmcount").permitAll()
				.requestMatchers(HttpMethod.GET, "/api/actors/{id}/film").permitAll()

				.requestMatchers(HttpMethod.POST, "/api/customers/**").permitAll()
//				.requestMatchers(HttpMethod.GET, "/api/customers/lastname/{ln}").permitAll()
//				.requestMatchers(HttpMethod.GET, "/api/customers/firstname/{fn}").permitAll()
//				.requestMatchers(HttpMethod.GET, "/api/customers/email/{email}").permitAll()
//				.requestMatchers(HttpMethod.PUT, "/api/customers/{id}/{addressId}").permitAll()
...
//				.requestMatchers(HttpMethod.GET, "/api/inventory/film/{id}/store/{id}").hasAnyRole("USER", "STAFF")
				...
				.requestMatchers(HttpMethod.POST, "/api/rental/**").permitAll()
